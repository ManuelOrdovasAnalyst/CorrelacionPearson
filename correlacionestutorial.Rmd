...
La correlación de Pearson es un método que permite establecer **relación lineal** entre variables, su resultado es un número que varía de -1 a 1, números negativos indican una relación inversa entre variables, positivo una relación directa, y cunato más cercanos a 0, menos relación lineal es encontrada entre variables.
